 ...
 */
final class Version20240328182024 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "like" (id INT NOT NULL, author_id INT DEFAULT NULL, comment_id INT DEFAULT NULL, article_id INT DEFAULT NULL, PRIMARY KEY(id))');
